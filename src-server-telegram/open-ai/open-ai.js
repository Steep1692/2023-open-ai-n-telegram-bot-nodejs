...
var configuration = new Configuration({
    apiKey: config_1.OPEN_AI_TOKEN,
});
var openai = new OpenAIApi(configuration);
var askOpenAI = function (question) { return __awaiter(void 0, void 0, void 0, function () {
    var completion;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                completion = _a.sent();
                return [2 /*return*/, completion.data.choices[0].text];
        }
    });
}); };
